...
class TranslationController extends SettingController
{
    ...
    public function postPublish(Request $request)
    {
        ...
        return $this
            ->httpResponse()
            ->setMessage(trans('plugins/translation::translation.done_publishing'));
    }
    ...
    public function postLocales(LocaleRequest $request)
    {
        if (! File::isWritable(lang_path()) || ! File::isWritable(lang_path('vendor'))) {
            return $this
                ->httpResponse()
    ...
    public function postThemeTranslations(Request $request)
    {
    ...
    public function ajaxGetAvailableRemoteLocales(Manager $manager)
    {
        ...
        foreach ($remoteLocales as $locale) {
            ...
            foreach ($listLanguages as $key => $language) {
                if (
                    in_array($key, [$locale, str_replace('-', '_', $locale)])
    ...
    public function ajaxDownloadRemoteLocale(string $locale, Manager $manager)
    {
