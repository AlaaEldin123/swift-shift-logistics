...
abstract class FormAbstract extends Form implements ExtensibleContract
{
    ...
    public static function create(array $options = [], array $data = []): FormAbstract
    {
        return app(FormBuilder::class)->create(static::class, $options, $data);
    }

    public static function createFromArray(array $object, array $options = [], array $data = []): FormAbstract
    {
        return static::create([...$options, 'model' => $object], $data);
    }

    public static function createFromModel(BaseModel|Model $model, array $options = [], array $data = []): FormAbstract
    {
