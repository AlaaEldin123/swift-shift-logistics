<form method="post" action="{{ route('logistics.request-quote') }}" id="request-quote-form">
    <div class="row align-items-center">
        ...
        @foreach($customFields as $customField)
            ...
            @elseif($customField->type == \Botble\Logistics\Enums\CustomFieldType::CHECKBOX)
                @continue(! $customField->options->filter(fn ($option) => ! empty($option->label)))
                <div class="col-md-12">
                    <div class="mb-3">
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                <textarea class="form-control" name="message" rows="5" placeholder="{{ __('Message / Note') }}"></textarea>
            </div>
        </div>
